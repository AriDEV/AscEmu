...
class SERVER_DECL AIInterface : public Arcemu::IUpdatable
{
    public:
        ...
        void StopFlying() { if (Flying()) { m_spline.SetSplineFlag(0); SetWalk(); } }
    ...
    public:
        ...
        bool MoveDone() { return m_currentMoveSplineIndex >= m_Unit->m_movementManager.m_spline.GetSplinePoints()->size(); }
